        ...
        {activeChat && (
          <div className="flex items-center ml-4">
            <button
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center text-text-muted hover:text-accent hover:bg-accent/10 transition-colors shrink-0"
              title="Audio Call"
            >
            ...
            <button
              onClick={() => useCallStore.getState().setOutgoingCall(activeChatId!, 'video')}
              className="w-10 h-10 rounded-full flex items-center justify-center text-text-muted hover:text-accent hover:bg-accent/10 transition-colors shrink-0"
              title="Video Call"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
